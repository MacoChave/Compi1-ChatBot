...
namespace ChatBot.Compilador
{
    class Ejecutar
    {
        public object AnalisisSemantico(ParseTreeNode root, string H_AMBITO = "GLOBLAL", string H_TIPO_PROC = "void", bool H_FLUJO_CONTROL = false)
        {
            object result = null;
        ...
        private static object OperadorSuma(object valor1, object valor2, int columna, int fila)
        {
            ...
            if (valor1 is int || valor2 is int)
            {
                ...
                if (valor1 is bool)
                    return BoolAInt((bool)valor1) + (int)valor2;
                if (valor2 is bool)
                    return (int)valor1 + BoolAInt((bool)valor2);
                return (int)valor1 + (int)valor2;
            }
            if (valor1 is double || valor2 is double)
            {
                if (valor1 is bool)
                    return BoolAInt((bool)valor1) + (double)valor2;
                if (valor2 is bool)
                    return (double)valor1 + BoolAInt((bool)valor2);
                if (valor1 is char)
            ...
            if (valor1 is bool || valor2 is bool)
                return BoolAInt((bool)valor1) + BoolAInt((bool)valor2);
        ...
        private static object OperadorDiv(object valor1, object valor2, int columna, int fila)
        {
            ...
            if (valor1 is int || valor2 is int)
            {
                ...
                if (valor1 is bool)
                    return (double)(BoolAInt((bool)valor1) / (int)valor2);
                if (valor2 is bool)
                    return (double)((int)valor1 / BoolAInt((bool)valor2));
        ...
        private static object OperadorPot(object valor1, object valor2, int columna, int fila)
        {
            ...
            if (valor1 is int || valor2 is int)
            {
                ...
                if (valor1 is bool)
                    return Math.Pow(BoolAInt((bool)valor1), (int)valor2);
                if (valor2 is bool)
                    return Math.Pow((int)valor1, BoolAInt((bool)valor2));
            ...
            {
                if (valor1 is bool)
                    return Math.Pow(BoolAInt((bool)valor1), (double)valor2);
                if (valor2 is bool)
                    return Math.Pow((double)valor1, BoolAInt((bool)valor2));
        ...
        private static int BoolAInt(bool valor)
        {
            return (valor) ? 1 : 0;
        }
